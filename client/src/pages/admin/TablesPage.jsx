...
const statusColors = { available: 'bg-emerald-100 border-emerald-300 text-emerald-700', occupied: 'bg-red-100 border-red-300 text-red-700', reserved: 'bg-blue-100 border-blue-300 text-blue-700', cleaning: 'bg-amber-100 border-amber-300 text-amber-700', out_of_service: 'bg-gray-100 border-gray-300 text-gray-500' };
